...
### Test Step
A Test Step consists of one or more Elements (Manifest, Assert, Delete). A Test Step could consist of just one Delete or multiple Manifests, an Assert, and a Delete. In a Test Step where there are multiple types of Elements, the order that they are run is as follows: Manifest, Assert, Delete.
